...
class PremiumGameProvider with ChangeNotifier {
  ...
  final List<PremiumGameModel> _cloudLibrary = [
    const PremiumGameModel(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1603481546238-487240415921?q=80&w=800&auto=format&fit=crop',
      price: 9.99,
      rating: 4.9,
    ...
    const PremiumGameModel(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1511193311914-0346f16bee90?q=80&w=800&auto=format&fit=crop',
      price: 1.49,
      rating: 4.5,
